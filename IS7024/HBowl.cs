...
namespace QuickTypeBowl
{
    ...
    public enum City { HollywoodCaUs };

    public enum Billing { Headline, Support };

    public enum Status { Ok };

    public enum TypeEnum { Concert };

    public enum VenueDisplayName { HollywoodBowl };
    ...
    public partial class HBowl
    {
        public static HBowl FromJson(string json) => JsonConvert.DeserializeObject<HBowl>(json, QuickTypeBowl.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this HBowl self) => JsonConvert.SerializeObject(self, QuickTypeBowl.Converter.Settings);
    }
    ...
    internal class CityConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            if (value == "Hollywood, CA, US")
            {
                return City.HollywoodCaUs;
            }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            if (value == City.HollywoodCaUs)
            {
                serializer.Serialize(writer, "Hollywood, CA, US");
                return;
            }
    ...
    internal class VenueDisplayNameConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            if (reader.TokenType == JsonToken.Null) return null;
            var value = serializer.Deserialize<string>(reader);
            if (value == "Hollywood Bowl")
            {
                return VenueDisplayName.HollywoodBowl;
            }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            if (value == VenueDisplayName.HollywoodBowl)
            {
                serializer.Serialize(writer, "Hollywood Bowl");
                return;
            }
